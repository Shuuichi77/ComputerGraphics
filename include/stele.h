...
static double const PEDESTAL_X = 0.5;
static double const PEDESTAL_Y = FLOOR_X;
static double const PEDESTAL_Z = PEDESTAL_X;

static double const TOWER_X = PEDESTAL_X * 0.8;
static double const TOWER_Y = TOWER_X;
static double const TOWER_Z = 3;
